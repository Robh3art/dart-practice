...
void main() {
  ...
  print("before swap" "${var1 = 10} ${var2 = 5}");
  var1 = var1 + var2;
  var2 = var1 - var2;
  var1 = var1 - var2;
  print("after swap" "${var2 = 5} ${var1 = 10}");
}
...
int ageOfAthelete = 40;
int rank = 2;
String name = "Kipchoge";
...
List sportsKenya = ["swimming", "football", "rugby", "basketball"];
